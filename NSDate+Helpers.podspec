Pod::Spec.new do |s|
  ...
  s.description      	= "NSDate class's cetogory that adds methods: getStringFromDate, getDateFromString, timeZoneAbbreviations."
  s.homepage         	= "https://github.com/Bogdan-Stasjuk/NSDate-Helpers"
  s.license      		= { :type => 'MIT', :file => 'LICENSE' }
  s.author           	= { "Bogdan Stasjuk" => "Bogdan.Stasjuk@gmail.com" }
  s.source           	= { :git => "https://github.com/Bogdan-Stasjuk/NSDate-Helpers.git", :tag => '0.1.0' }
